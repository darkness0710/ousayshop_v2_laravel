...
class GameController extends Controller
{
    ...
    {
        $posts = Post::whereIn('type', ['4'])->publish()->get();
    ...
    {
        $posts = Post::whereIn('type', ['3'])->publish()->get();
