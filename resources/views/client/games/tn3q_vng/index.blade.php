                        ...
                        <div class="col-md-4">
                            <div class="card card-plain card-blog">
                                <div class="card-header card-header-image">
                                    <a href="{{ route('client.games.tn3q_vng.show', $post->slug) }}">
                                        <img class="img img-raised" src="{{ asset('images/client_game_tn3q_vng.jpg') }}">
                                    </a>
                                <div class="colored-shadow" style=""></div></div>
                                <div class="card-body">
                                    <h4 class="card-title">
                                        <a href="{{ route('client.games.tn3q_vng.show', $post->slug) }}">{{ $post->name }}</a>
                                    </h4>
